...
namespace PragmaOnce.Service.src.Shared
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            // Talent hub
            CreateMap<CandidateProfile, CandidateReadDto>();
            CreateMap<CandidateCreateDto, CandidateProfile>();
            CreateMap<CandidateUpdateDto, CandidateProfile>();

            CreateMap<RecruiterProfile, RecruiterReadDto>();
            CreateMap<RecruiterCreateDto, RecruiterProfile>();
            CreateMap<RecruiterUpdateDto, RecruiterProfile>();
